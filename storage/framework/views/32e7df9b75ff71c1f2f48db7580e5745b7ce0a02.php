                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo e($supplier->ncc_ma); ?></td>
                                                        <td><?php echo e($supplier->ncc_ten); ?></td>
                                                        <td><?php echo e($supplier->ncc_email); ?></td>
                                                        <td><?php echo e($supplier->ncc_dienThoai); ?></td>
                                                        <td><?php echo e($supplier->ncc_diaChi); ?></td>
                                                        <td><div class="table-actions">                                                  
                                                            <a href="<?php echo e(URL::to('/edit-supplier/'.$supplier->ncc_ma)); ?>"><i class="ik ik-edit-2 text-yellow"></i></a>
                                                            <i class="ik ik-trash-2 delete text-red" id="<?php echo e($supplier->ncc_ma); ?>"></i>
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ShoesStore\ShoesShop\resources\views/admin/manage_suppliers.blade.php ENDPATH**/ ?>