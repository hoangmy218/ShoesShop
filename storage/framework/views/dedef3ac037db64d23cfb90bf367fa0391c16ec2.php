						...
						<div class="row">
							...
							<div class="col-xs-6 text-right">
								<address>
									...
									<strong><?php echo e($order->dh_tenNguoiNhan); ?></strong><br>
									<?php echo e($order->dh_diaChiNhan); ?><br>
									Phone: <?php echo e($order->dh_dienThoaiNhan); ?><br>
									&nbsp;
								</address>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-6">
								<address>											        
                                    ...
                                    <b>Hình thức thanh toán:</b> <?php echo e($order->httt_ten); ?><br>
									...
									<tbody>
										...
										<?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<tr>
                                                ...
                                                <td class="text-center"><?php echo e($item->ms_ten); ?></td>
                                                <td class="text-center"><?php echo e($item->kc_ten); ?></td>
												...
												<td class="text-right"><?php echo e(number_format($thanhTien).' VND'); ?></td>
											</tr>
										...
										<tr>
											...
											<td class="text-right"><strong><?php echo e(number_format($order->htvc_phi).' VND'); ?></strong></td>
										</tr>
										<tr class="tongtien">
											<td colspan="3">
											</td><td  colspan="3" class="text-right"><strong>Tổng tiền thanh toán</strong></td>
											<td class="text-right"><strong><?php echo e(number_format($congTien+$order->htvc_phi - $disc).' VND'); ?></strong></td>
										</tr>
									</tbody>
								</table>
							</div>									
...
</html><?php /**PATH C:\xampp\htdocs\ShoesStore\ShoesShop\resources\views/admin/order_pdf.blade.php ENDPATH**/ ?>