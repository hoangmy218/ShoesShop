                        ...
                        <div class="nav-container">
                            <nav id="main-menu-navigation" class="navigation-main">
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                        <a id="themmausac" href="<?php echo e(URL::to('/add-color')); ?>" class="menu-item">Thêm màu sắc</a>
                                        <a id="danhsachmausac" href="<?php echo e(URL::to('/manage-color')); ?>" class="menu-item">Danh sách màu sắc</a>
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                        <a id="themkichco" href="<?php echo e(URL::to('/add-size')); ?>" class="menu-item">Thêm kích cỡ</a>
                                        <a id="danhsachkichco" href="<?php echo e(URL::to('/manage-size')); ?>" class="menu-item">Danh sách kích cỡ</a>
                                ...
                                <div class="nav-item has-sub">  <!-- Tiên 6/05 -->
                                    ...
                                    <div class="submenu-content">
                                        ...
                                        <a href="<?php echo e(URL::to('/manage-comment')); ?>" class="menu-item">Danh sách bình luận</a>
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                        <a id="themthanhtoan" href="<?php echo e(URL::to('/add-pay')); ?>" class="menu-item">Thêm phương thức thanh toán</a>
                                        <a id="danhsachthanhtoan" href="<?php echo e(URL::to('/manage-pay')); ?>" class="menu-item">Danh sách phương thức <br> thanh toán</a>
...
<?php /**PATH C:\xampp\htdocs\ShoesStore\ShoesShop\resources\views/admin_layout.blade.php ENDPATH**/ ?>