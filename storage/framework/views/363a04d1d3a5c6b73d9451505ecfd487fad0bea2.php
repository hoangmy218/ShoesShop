                                                ...
                                                <div class="form-group" style="padding-bottom: 10px;">
                                                    <label for="date">Nhà cung cấp</label>
                                                       ...
                                                       <select class="form-control" name="nhacungcap" >
                                                            <?php $__currentLoopData = $list_suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $supllier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($supllier->ncc_ma); ?>"><?php echo e($supllier->ncc_ten); ?>&ensp;</option>                                                  
                                                ...
                                                <div data-repeater-item="item-a" class="d-flex mb-2">
                                                    ...
                                                    <div class="form-group  mb-2 mr-sm-2 mb-sm-0">
                                                       <select class="form-control" name="masp" >
                                                            <?php $__currentLoopData = $list_pro; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($pro->sp_ma); ?>"><?php echo e($pro->sp_ten); ?>&ensp;</option>                                                  
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </div>                                                   
                                                    ...
                                                    <div class="form-group  mb-2 mr-sm-2 mb-sm-0">
                                                       <select class="form-control" name="mams" >
                                                            <?php $__currentLoopData = $list_col; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($col->ms_ma); ?>"><?php echo e($col->ms_ten); ?>&ensp;</option>                                                  
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-group  mb-2 mr-sm-2 mb-sm-0">
                                                       <select class="form-control" name="makc" >
                                                            <?php $__currentLoopData = $list_sz; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $sz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($sz->kc_ma); ?>"><?php echo e($sz->kc_ten); ?>&ensp;</option>                                                  
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ShoesStore\ShoesShop\resources\views/admin/add_receipt.blade.php ENDPATH**/ ?>