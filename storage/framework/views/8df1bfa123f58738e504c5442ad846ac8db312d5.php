                        ...
                        <div class="page-header">
                            <div class="row align-items-end">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="forms-sample" action="<?php echo e(URL::to('/save-size')); ?>" method="POST">
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ShoesStore\ShoesShop\resources\views/admin/add_size.blade.php ENDPATH**/ ?>