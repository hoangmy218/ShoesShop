    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header"><h3>Chỉnh sửa thông tin quảng cáo</h3></div>
                <div class="card-body">
                    <?php $__currentLoopData = $edit_ad; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $ad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <form class="forms-sample" action="<?php echo e(URL::to('/update-advertisement/'.$ad->qc_ma)); ?>" method="POST" enctype="multipart/form-data" >
                        <?php echo e(csrf_field()); ?>

                        <div class="form-group">
                                <label for="exampleInputName1">Mã quảng cáo</label>
                                <input type="text" class="form-control" id="exampleInputName1" value="<?php echo e($ad->qc_ma); ?>" disabled="disabled">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputName1">Chủ đề quảng cáo</label>
                                <input type="text" name="ad_topic" class="form-control" id="exampleInputName1" value="<?php echo e($ad->qc_chuDe); ?>">
                            </div>
                            <!-- S Ngân (14/4/2020) -->
                            <div class="form-group">
                                <label for="exampleInputName1">Đoạn giới thiệu</label>
                                <input type="text" name="ad_DoanQC" class="form-control" id="exampleInputName1" value="<?php echo e($ad->qc_quangCao); ?>">
                            </div>
                           <!-- E Ngân (14/4/2020) -->
                            <div class="form-group">
                                <label for="exampleInputEmail1">Hình ảnh</label> <br>

                                <img src="<?php echo e(URL::to('public/upload/advertisement/'.$ad->qc_hinhAnh)); ?>"height="100" width="200">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\GitHub\ShoesShopWebsite\shoesshop\resources\views/admin/edit_Advertisement.blade.php ENDPATH**/ ?>