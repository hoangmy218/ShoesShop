                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="position-center">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputName1" name="brand_ma" value="<?php echo e($edit_value->th_ma); ?>" disabled="disabled"> <!-- Tien (04/05/2020) thêm disabled="disabled" -->
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputName1">Tên thương hiệu</label>
                                                <input type="text" value="<?php echo e($edit_value->th_ten); ?>" name="brand_name" class="form-control" id="exampleInputName1" placeholder="Name" >
                                            </div>
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shoesshop\resources\views/admin/edit_brand_product.blade.php ENDPATH**/ ?>