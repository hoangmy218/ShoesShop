                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo e($order->dh_tenNhan); ?> / <?php echo e($order->dh_diaChiNhan); ?> / <?php echo e($order->dh_dienThoai); ?> / <?php echo e($order->vc_ten); ?> </td>
                                                        <td><?php echo e(date('d-m-Y',strtotime($order->dh_ngayDat))); ?></td>
                                                        
                                                        <td><?php echo e($order->tt_ten); ?></td>
                                                        <td><?php echo e(number_format($order->dh_tongTien).' VND'); ?></td>
                                                        <td>
                                                            <?php switch($order->dh_trangThai):
                                                                case ('Chờ xử lý'): ?>
                                                                   <span class="badge badge-pill badge-warning"><?php echo e($order->dh_trangThai); ?></span>
                                                                    <?php break; ?>

                                                                <?php case ('Đã xử lý'): ?>
                                                                    <span class="badge badge-pill badge-primary"><?php echo e($order->dh_trangThai); ?></span>
                                                                    <?php break; ?>

                                                                <?php case ('Đang giao'): ?>
                                                                    <span class="badge badge-pill badge-info"><?php echo e($order->dh_trangThai); ?></span>
                                                                    <?php break; ?>
                                                                <?php case ('Đã giao'): ?>
                                                                   <span class="badge badge-pill badge-success"><?php echo e($order->dh_trangThai); ?></span>
                                                                    <?php break; ?>
                                                                <?php case ('Đã hủy'): ?>
                                                                   <span class="badge badge-pill badge-danger"><?php echo e($order->dh_trangThai); ?></span>
                                                                    <?php break; ?>
                                                        ...
                                                        <td><div class="table-actions" style="text-align: left">
                                                           ...
                                                           <?php switch($order->dh_trangThai):
                                                            ...
                                                            <?php if($order->dh_trangThai != 'Đã hủy'): ?>
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\GitHub\ShoesShopWebsite\shoesshop\resources\views/admin/manage_order.blade.php ENDPATH**/ ?>