                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><div class="table-actions">                                                  
                                                            <a href="<?php echo e(URL::to('/edit-color/'.$color->ms_ma)); ?>"><i class="ik ik-edit-2"></i></a>
                                                             ...
                                                             <!-- <a onclick="return confirm('Bạn chắc chắn muốn xóa?')" href="<?php echo e(URL::to('/delete-color/'.$color->ms_ma)); ?>"><i class="ik ik-trash-2"></i></a> -->
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ShoesStore\ShoesShop\resources\views/admin/manage_color.blade.php ENDPATH**/ ?>