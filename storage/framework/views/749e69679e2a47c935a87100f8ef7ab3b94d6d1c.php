                            ...
                            <div class="row align-items-end">
                                ...
                                <div class="col-lg-4">
                                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="<?php echo e(URL::to('/manage-product')); ?>">Quản lý hình thức vận chuyển</a>
                                            </li>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="forms-sample" action="<?php echo e(URL::to('/update-transport/'.$edit->vc_ma)); ?>" method="POST" enctype="multipart/form-data" >
                                             <?php echo e(csrf_field()); ?>

                                            <div class="form-group">
                                                <label for="exampleInputName1">Tên hình thức vận chuyển</label>
                                                <input type="text" name="transport_name" class="form-control" id="exampleInputName1" value="<?php echo e($edit->vc_ten); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputName1">Chi phí</label>
                                                <input type="text" name="transport_price" class="form-control" id="exampleInputName1" value="<?php echo e($edit->vc_phi); ?>">
                                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\GitHub\ShoesShopWebsite\shoesshop\resources\views/admin/edit_transport.blade.php ENDPATH**/ ?>