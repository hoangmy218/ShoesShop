				...
				<div class="col-lg-6 product-details pl-md-5 ftco-animate">
    				...
    				<div class="rating d-flex">
							...
							<p class="text-left mr-4">
								<a href="#" class="mr-2" style="color: #000;">
									<?php echo e($total_view); ?>

									<span style="color: #bbb;"><?php echo e(__('Đánh giá')); ?></span>
								</a>
							</p>
							<p class="text-left">
								...
								<a href="#" class="mr-2" style="color: #000;">
									...
									<?php echo e($sold_product); ?><!-- tiên 11/05 -->
    				...
    				<p class="price"><span><?php echo e(number_format($value->sp_donGiaBan).' '.'VNĐ'); ?></span></p>
						...
						<div class="row mt-4">
						            ...
						            <div class="select-wrap">
					                  <div class="icon">
										...
										<select id="mausac" name="mausac" class="form-control" required="" pattern="" style="width:200px" >
						                	<option value=""  selected disabled><?php echo e(__('Chọn màu sắc')); ?></option>
						                 	
						                  	<?php $__currentLoopData = $arr_ms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					        ...
					        <br>
					        <div class="col-md-12">
					        	<!-- <?php $__currentLoopData = $sz_product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $conlai): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					          		<p style="color: #000;">Size <?php echo e($conlai->kc_ten); ?> màu <?php echo e($conlai->ms_ten); ?> có sẵn <?php echo e($conlai->soLuongTon); ?> đôi</p> 
					            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> -->
					        </div>
				        	</div>
              	...
              	<div class="row p-4">
						   		 ...
						   		 <div class="col-md-7 "> <!-- Tiên 14/03 -->
						   			...
						   			<div class="review">
								   		...
								   		<div class="desc">
								   			<h4>
								   				<span class="text-left"><?php echo e($comment->nd_ten); ?></span>
								   				<span class="text-right"><?php echo e($comment->ngayBinhLuan); ?></span>
								   				<!-- <span class="text-right"><?php echo e(date('d/m/Y H:i',strtotime($comment->created_at))); ?></span> -->
								   			</h4>
								   			<p class="star" >
								   				<span> 
								   					<i class="ik ik-star-on ik-1x" ></i> <!-- ik ik-star-on là màu đen và ngược lại -->
								   					<i class="ik ik-star-on ik-1x"></i> 
								   					<i class="ik ik-star-on ik-1x" ></i>
								   					<i class="ik ik-star-on ik-1x" ></i>
								   					<i class="ik ik-star ik-1x" ></i>
							   					</span>
							   					<span class="text-right"><a href="#" class="reply"><i class="icon-reply"></i></a></span>
								   			</p>
								   			<p><?php echo e($comment->noiDung); ?></p>
								   		</div>
								   	</div>
								   	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>		
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
        	...
        	$('select[name="mausac"]').on('change',function(){
                ...
                var kc_ma=$('select[name="size"]').val();
                var sp_ma=$('#spma').val();
            ...
            $('select[name="size"]').on('change',function(){
                ...
                var ms_ma=$('select[name="mausac"]').val();
                var sp_ma=$('#spma').val();
                console.log(kc_ma,'kc_ma'); 
                console.log(ms_ma,'ms_ma');
                if(kc_ma){
...
<?php echo $__env->make('shop_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ShoesStore\ShoesShop\ShoesShop\resources\views/pages/product/show_detail.blade.php ENDPATH**/ ?>