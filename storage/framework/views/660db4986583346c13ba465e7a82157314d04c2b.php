				...
				<div class="col-lg-6 product-details pl-md-5 ftco-animate">
    				...
    				<div class="rating d-flex">
							...
							<p class="text-left mr-4">
								<a href="#" class="mr-2" style="color: #000;"><?php echo e($total_view); ?> <span style="color: #bbb;"><?php echo e(__('Đánh giá')); ?></span></a>
							</p>
							<p class="text-left">
...
<?php echo $__env->make('shop_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\GitHub\ShoesShopWebsite\shoesshop\resources\views/pages/product/show_detail.blade.php ENDPATH**/ ?>