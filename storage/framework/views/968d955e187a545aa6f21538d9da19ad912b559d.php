...
<html class="no-js')}}" lang="en">
    <head>
        ...
        <!-- <link rel="icon" href="<?php echo e(asset('public/backend/favicon.ico')); ?>" type="image/x-icon" /> -->
    ...
    <body>
            ...
            <div class="container-fluid h-100">
                <div class="row flex-row h-100 bg-white">
                    <div class="col-xl-8 col-lg-6 col-md-5 p-0 d-md-block d-lg-block d-sm-none d-none">
                        <div class="lavalite-bg" style="background-image: url(<?php echo e(asset('public/backend/img/auth/login-bg.jpg')); ?>);">
                     ...
                     <div class="col-xl-4 col-lg-6 col-md-7 my-auto p-0">
                        <div class="authentication-form mx-auto">
                            <!-- <div class="logo-centered">
                                <a href="<?php echo e(asset('public/backend/index.html')); ?>"><img src="<?php echo e(asset('public/backend/src/img/brand.svg')); ?>" alt=""></a>
                            </div> -->
                            ...
                            ?></b></p> 
                            <form action="<?php echo e(URL::to('admin_dashboard')); ?>" method="post">
        ...
        <script src="<?php echo e(asset('public/backend/dist/js/theme.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\GitHub\ShoesShopWebsite\shoesshop\resources\views/admin_login.blade.php ENDPATH**/ ?>