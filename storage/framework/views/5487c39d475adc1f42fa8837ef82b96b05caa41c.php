                                    ...
                                    <div class="card-body p-0 table-breceipt-style">
                                        <div class="table-responsive">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    <?php $i=1; ?>
                                                	<?php $__currentLoopData = $list_receipts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $receipt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <th scope="row"><?php echo e($i); ?></th>
                                                        <td><?php echo e($receipt->pn_ma); ?></td>
                                                        <td><?php echo e(date('d-m-Y',strtotime($receipt->pn_ngayNhap))); ?></td>
                                                        <td ><?php echo e($receipt->count); ?></td>
                                                        <td style="text-align: right;"><?php echo e(number_format($receipt->pn_tongTien).' VND'); ?></td>
                                                        <td><div class="table-actions" style="text-align: left">
                                                            <a href="<?php echo e(URL::to('/view-receipt/'.$receipt->pn_ma)); ?>"><i class="ik ik-eye f-16 mr-15 text-blue"></i></a> 
                                                            <a><i id="<?php echo e($receipt->pn_ma); ?>" class="ik ik-edit-2 f-16 mr-15 edit text-green"></i></a> 
                                                            
                                                            <a> <i class="ik ik-trash-2 f-16 mr-15 delete text-red" id="<?php echo e($receipt->pn_ma); ?>"></i></a>
                                                        </div></td>
                                                    </tr>
                                                    <?php $i++; ?>
    ...
    $(document).ready(function(){
        ...
        $(document).on('click','.edit', function(){
            ...
            if (pn_ma){
                ...
                $.ajax({
                    url: "<?php echo e(url('getDateReceipt')); ?>",
                        dataType: 'json',
                        type: 'GET',
                        data:{
                            pn_ma: pn_ma,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ShoesStore\ShoesShop\resources\views/admin/manage_goods_receipt.blade.php ENDPATH**/ ?>