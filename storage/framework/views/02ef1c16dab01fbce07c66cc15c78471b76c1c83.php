                                    ...
                                    <div class="card-body p-0 table-border-style">
                                        <div class="table-responsive">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    <?php {{$i=1;}} ?>
                                                	<?php $__currentLoopData = $list_brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                    <tr>
                                                        <th scope="row"><?php echo e($i); ?></th>
                                                        <td><?php echo e($brand->th_ma); ?></td>
                                                        <td><?php echo e($brand->th_ten); ?></td>
                                                        <td><div class="table-actions">                                                  
                                                            <a href="<?php echo e(URL::to('/edit-brand-product/'.$brand->th_ma)); ?>"><i class="ik ik-edit-2"></i></a>

                                                             <i class="ik ik-trash-2 delete text-red" id="<?php echo e($brand->th_ma); ?>"></i>

                                                             <!-- <a onclick="return confirm('Bạn chắc chắn muốn xóa?')" href="<?php echo e(URL::to('/delete-brand-product/'.$brand->th_ma)); ?>"><i class="ik ik-trash-2"></i></a> -->
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shoesshop1\resources\views/admin/manage_Brand.blade.php ENDPATH**/ ?>