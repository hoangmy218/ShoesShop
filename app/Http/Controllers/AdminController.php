...
class AdminController extends Controller
{
    ...
    public function view_history($Controll_nd_ma){
            ...
            $trangthaihang=DB::table('trangthai')->orderby('tt_ma','desc')->get();
            return view('admin.view_history')->with('ten', $ten)->with('don_hang',$don_hang)->with('trangthaihang', $trangthaihang);
        }
